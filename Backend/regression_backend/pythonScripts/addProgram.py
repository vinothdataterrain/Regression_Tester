...
with sync_playwright() as p:
    ...
    try:
        ...
        # Step 7
        log("Step 7: Cicking Add program button")
        page.click("a:has-text('Add Program')")
        page.wait_for_load_state('networkidle')
        take_screenshot(page, "Add Program clicked")

        # Step 8
        log("Step 8: Clicking select program dropdown")
        page.click("div.react-select__control")
        page.wait_for_load_state('networkidle')
        page.wait_for_timeout(5000)
        take_screenshot(page, "Select program dropdown clicked")

        # Step 9
        log("Step 9: Clicking program options")
        ...
        page.wait_for_timeout(5000)
        take_screenshot(page, "Save button clicked")



                
        log("✅ Login and Add Program flow done successfully!")
